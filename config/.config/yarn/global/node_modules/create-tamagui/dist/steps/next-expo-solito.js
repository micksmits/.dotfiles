...
var next_expo_solito_exports = {};
__export(next_expo_solito_exports, {
  default: () => next_expo_solito_default
});
module.exports = __toCommonJS(next_expo_solito_exports);
...
var main = async ({ isFullClone, projectName }) => {
  if (isFullClone) {
    console.log(`${import_chalk.default.green.bold("Done!")} created a new project under ./${projectName}
...
`);
  ...
  To start the Next.js development server, run:
    ${import_chalk.default.green(runCommand("web"))}
    
  To start Expo Go for mobile development, run:
    ${import_chalk.default.green(runCommand("native"))}

  You can also create Expo development builds by doing:
  
    ${import_chalk.default.green(`cd apps/expo`)} 
    then:
    ${import_chalk.default.green(runCommand("ios"))} 
    or...
    ${import_chalk.default.green(runCommand("android"))}

  Be sure to replace [yourprojectsname] with the uid you'd like for your app.
`);
};
var next_expo_solito_default = main;
//# sourceMappingURL=next-expo-solito.js.map
