...
var simple_web_exports = {};
__export(simple_web_exports, {
  default: () => simple_web_default
});
module.exports = __toCommonJS(simple_web_exports);
...
var main = async ({ isFullClone, projectName }) => {
  if (isFullClone) {
    console.log(`
  ${import_chalk.default.green.bold("Done!")} created a new project under ./${projectName}
...
var simple_web_default = main;
//# sourceMappingURL=simple-web.js.map
