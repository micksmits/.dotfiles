...
var require_figures = __commonJS({
  "../../node_modules/prompts/dist/util/figures.js"(exports, module2) {
    ...
    var figures = process.platform === "win32" ? win : main4;
...
var require_text2 = __commonJS({
  "../../node_modules/prompts/lib/elements/text.js"(exports, module2) {
    ...
    var { style, clear, strip, figures } = require_util3();
    var TextPrompt = class extends Prompt {
      constructor(opts = {}) {
        super(opts);
        this.transform = style.render(opts.style);
...
var require_date2 = __commonJS({
  "../../node_modules/prompts/lib/elements/date.js"(exports, module2) {
    ...
    var color = require_kleur();
    var Prompt = require_prompt2();
    var { style, clear, figures, strip } = require_util3();
    var { erase, cursor } = require_src();
...
var require_multiselect2 = __commonJS({
  "../../node_modules/prompts/lib/elements/multiselect.js"(exports, module2) {
    ...
    var { cursor } = require_src();
    var Prompt = require_prompt2();
    var { clear, figures, style } = require_util3();
    var MultiselectPrompt = class extends Prompt {
      constructor(opts = {}) {
        super(opts);
        this.msg = opts.message;
...
var makeRainbowChalk = (text) => text.split("").map((char, idx) => import_chalk.default.hex(rainbowColors[idx % rainbowColors.length])(char)).join("");

// src/steps/next-expo-solito.ts
...
var tamaguiRainbowAsciiArt = function() {
  const char0_1 = import_chalk4.default.hex(rainbowColors[0])("\u2580\u2588\u2580");
  const char0_2 = import_chalk4.default.hex(rainbowColors[0])(" \u2588 ");
  const char1_1 = import_chalk4.default.hex(rainbowColors[1])("\u2584\u2580\u2588");
  const char1_2 = import_chalk4.default.hex(rainbowColors[1])("\u2588\u2580\u2588");
  const char2_1 = import_chalk4.default.hex(rainbowColors[2])("\u2588\u2580\u2584\u2580\u2588");
  const char2_2 = import_chalk4.default.hex(rainbowColors[2])("\u2588 \u2580 \u2588");
  const char3_1 = import_chalk4.default.hex(rainbowColors[3])("\u2584\u2580\u2588");
  const char3_2 = import_chalk4.default.hex(rainbowColors[3])("\u2588\u2580\u2588");
  const char4_1 = import_chalk4.default.hex(rainbowColors[4])("\u2588\u2580\u2580");
  const char4_2 = import_chalk4.default.hex(rainbowColors[4])("\u2588\u2584\u2588");
  const char5_1 = import_chalk4.default.hex(rainbowColors[5])("\u2588 \u2588");
  const char5_2 = import_chalk4.default.hex(rainbowColors[5])("\u2588\u2584\u2588");
  const char6_1 = import_chalk4.default.hex(rainbowColors[6])("\u2588");
  const char6_2 = import_chalk4.default.hex(rainbowColors[6])("\u2588");
...
`);
  console.log();
  const { setupSupabase } = await (0, import_prompts.default)({
    name: "setupSupabase",
  ...
  if (setupSupabase) {
    console.log();
    const { startLocalSupabase } = await (0, import_prompts.default)({
...
cd into the project using:
  ...
  To start developing for iOS, run:
    ${import_chalk5.default.green(runCommand3("ios"))}

  To start developing for Android, run:
    ${import_chalk5.default.green(runCommand3("android"))}

  To run Supabase scripts, cd into the supabase package:
    ${import_chalk5.default.green("cd supabase")}

    ${import_chalk5.default.green("yarn reset")} - Resets local database
    ${import_chalk5.default.green("yarn generate")} - Generates new types

    Find info on the rest of the scripts in ${import_chalk5.default.cyan(`supabase/README.md`)}

    If you've purchased and gained access to font and icon packages, you can run:
    ${import_chalk5.default.green("yarn tamagui add icon")}
    ${import_chalk5.default.green("yarn tamagui add font")}
  `);
};
