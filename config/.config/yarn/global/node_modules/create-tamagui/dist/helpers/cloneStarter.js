...
var require_split = __commonJS({
  "../../node_modules/event-stream/node_modules/split/index.js"(exports, module2) {
  ...
  "../../node_modules/yaml/dist/nodes/Collection.js"(exports) {
    ...
    var Collection = class extends Node.NodeBase {
      ...
      clone(schema) {
        ...
        if (schema)
          copy2.schema = schema;
        copy2.items = copy2.items.map((it) => Node.isNode(it) || Node.isPair(it) ? it.clone(schema) : it);
        if (this.range)
          copy2.range = this.range.slice();
        return copy2;
      }
  ...
  "../../node_modules/yaml/dist/doc/Document.js"(exports) {
    ...
    var Document = class {
      ...
      clone() {
        ...
        copy2.contents = Node.isNode(this.contents) ? this.contents.clone(copy2.schema) : this.contents;
        if (this.range)
          copy2.range = this.range.slice();
        return copy2;
      }
...
async function setupTamaguiDotDir(template, isRetry = false) {
  ...
  if (isInSubDir) {
    ...
    (0, import_child_process.execSync)(cmd, { cwd: targetGitDir });
    console.log();
    console.log(`$ ${cmd}`);
  }
  try {
