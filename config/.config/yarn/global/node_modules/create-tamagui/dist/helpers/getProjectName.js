...
// src/helpers/getProjectName.ts
var getProjectName = async (projectPath) => {
  ...
  if (!projectPath) {
    const res = await (0, import_prompts.default)({
      ...
      initial: "myapp",
      validate: (name) => {
        const validation = validateNpmName(import_path.default.basename(import_path.default.resolve(name)));
        if (validation.valid) {
          return true;
        }
  ...
  if (!projectPath) {
    ...
    console.log(`  ${import_chalk.default.cyan(package_default.name)} ${import_chalk.default.green("<project-directory>")}`);
    console.log();
    console.log("For example:");
    console.log(`  ${import_chalk.default.cyan(package_default.name)} ${import_chalk.default.green("my-tamagui-app")}`);
    console.log();
    console.log(`Run ${import_chalk.default.cyan(`${package_default.name} --help`)} to see all options.`);
    process.exit(1);
  }
  return projectPath;
};
